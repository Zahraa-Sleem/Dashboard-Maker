...
namespace DashboardMaker.Data.Migrations
{
    ...
    [Migration("20231208155130_Color_ColorPalettes_Fixes")]
    partial class Color_ColorPalettes_Fixes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColorColorPalette", b =>
                {
                    b.Property<int>("ColorPalettesId")
                        .HasColumnType("int");

                    b.Property<string>("ColorsHexadecimalValue")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("ColorPalettesId", "ColorsHexadecimalValue");

                    b.HasIndex("ColorsHexadecimalValue");

                    b.ToTable("ColorsColorPalettes", (string)null);
                });
            ...
            modelBuilder.Entity("ColorColorPalette", b =>
                {
                    ...
                    b.HasOne("DashboardMaker.Models.Color", null)
                        .WithMany()
                        .HasForeignKey("ColorsHexadecimalValue")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
